...
describe('NDDB Diff', function() {
    ...
    describe("#diff()",function() {
        ...
        it("should not contain 2 of the items",function() {
            difference.select('title','=',"Water Lilies").execute().length.should.be.eql(0);
            difference.select('title','=',"Das Rätsel der Begierde").execute().length.should.be.eql(0);
        });
    });
    ...
    describe("#intersect",function() {
        ...
        it("should contain one masterpiece (item)",function() {
            difference.select('title','=',"Water Lilies").execute().length.should.be.eql(1);
        });
    });
