(function() {
    ...
    class Stream {
        ...
        constructor(opts = {}) {
            ...
            this.clearOnWrite = this.conf.clear || false;
        ...
        writeBuffer() {
            ...
            // TODO: could this be an option of NDDB.save?
            if (this.clearOnWrite) this.nddb.clear();
        }
     ...
     * ### NDDB.dump
     *
     * Streams and remove items from database as they are written down.
     *
     * @param {object} opts Optional. Configuration options (same as stream)
     *
     * @returns {Stream} a Stream object
     *
     * @see NDDB.stream
     */
    NDDB.prototype.dump = function(opts = {}) {
        opts.clear = true;
