...
module.exports = function(opts = {}) {
    ...
    this.save = (nddb, file, cb, opts) => {
        ...
        let str = jsonStringify(nddb, opts, 'save', this.type === 'ndjson');
    ...
    this.saveSync = (nddb, file, cb, opts) => {
        ...
        // TODO: maybe add a state for ndjson.
        let str = jsonStringify(nddb, opts, 'saveSync', this.type === 'ndjson');
...
const jsonStringify = (nddb, opts, method, ndjson) => {
