...
(function() {
    ...
    function processFileStreamInSync(fd, lineProcessorCb, options) {
        ...
        workload = '';
        pos = 'number' === typeof options.startFrom ? options.startFrom : null;
        read = fs.readSync(fd, buffer, 0, bufferSize, pos);
        ...
        // We can't do anything if lineBreak was an option.
        if (false && !options.lineBreak) {
        ...
        throw new Error('malformed csv file or wrong separator specified');
    }
