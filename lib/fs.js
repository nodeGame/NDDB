 ...
 */
NDDB.prototype.saveSync = function(file, cb, compress) {
 ...
 *
 * Refer to NDDB.saveSync for documentation
 */
 ...
 *
 * Loads from the file system using `fs.readFileSync` method.
 *
 ...
 *
 * Refer to NDDB.loadSync for documentation.
 */
